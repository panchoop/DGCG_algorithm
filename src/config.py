...
**time_weights** : numpy.ndarray, default np.ones(T)/T
...
**beta** : float, default 0.1
    Regularization coefficient of the problem
**f_t** : list[numpy.ndarray], default None
    Input data in the problem, represents a list of elements in H_t for each t.
**measure_coefficient_too_low** : float, default 1e-18
...
**rejection_sampling_epsilon** : float, default 0.05
...
**insertion_length_bound_factor** : float, default 1.1
...
**crossover_child_F_threshold** : float, default 0.8
...
**insertion_eps** : float, default 1e-10
...
**multistart_taboo_dist** : float, default 0.01
    The distance, in H^1 norm, of a curve to an element of the stationary
    set to be discarded.
**multistart_energy_dist** : float, default 0.01
    ...
    radius.
**multistart_early_stop** : callable[[int,int], int], default constant equal to
infinite
...
**multistart_descent_soft_max_threshold** : float, default 0.8
...
**CVXOPT_TOL** : float, default 1e-25
