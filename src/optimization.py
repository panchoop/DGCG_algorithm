...
def F_cl(curve_cl, current_data_cl):
    """ Correspond to the application of the F operator at the current set of
    curves. 

    Parameters
    ----------
    curve_cl : opencl.array 
        of shape (N, T), representing N curves.
    current_data_cl: opencl.array
        of shape (T, K), representing the data generated by the current measure
        corresponds to (K_t^*(μ) - f_t), an element in H.

    Returns
    -------
        N-length numpy array.
    """
