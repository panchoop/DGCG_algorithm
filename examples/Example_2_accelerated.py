""" Script to run Experiment 2 with 60% of noise and experimental acceleration.
...
if __name__ == "__main__":
    ...
    simulation_parameters = {
        ...
        'insertion_min_restarts': 5000,
        'results_folder': 'results_Exercise_2_noise60_accelerated',
